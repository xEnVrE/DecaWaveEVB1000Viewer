...
class Ui_EVB1000ViewerMainWindow(object):
    def setupUi(self, EVB1000ViewerMainWindow):
        ...
        self.logScrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 844, 108))
        ...
        self.planeHeightGroupBox.setMaximumSize(QtCore.QSize(400, 200))
        ...
        self.connectedTagsScrollAreaWidget.setGeometry(QtCore.QRect(0, 0, 372, 308))
        ...
        self.connectedTagsScrollAreaWidgetLayout.addItem(spacerItem1)
        ...
        self.anchorsScrollAreaWidget.setGeometry(QtCore.QRect(0, 0, 372, 308))
        ...
        self.anchorsScrollAreaWidgetLayout.addItem(spacerItem2)
